    ...
    const menuCategories = [
        {
            ...
            dishes: [
                { name: 'Мясное ассорти', price: 32, checked: false, half: true },
                ...
                { name: 'Мясное/Сырное ассорти', price: 50, checked: false, half: true },
                ...
                { name: 'Холодец', price: 20, checked: false, half: true },
                ...
                { name: 'Тарталетки ассорти', price: 32, checked: false, half: true },
                ...
                { name: 'Лимонная закуска', price: 10, checked: false, half: true },
                ...
                { name: 'Ягоды в мартинице', price: 18, checked: false, half: false },
                { name: 'Рулетики микс', price: 10, checked: false, half: true },
                { name: 'Арбуз и дыня в мартинице', price: 8, checked: false, half: false },
                ...
                { name: 'Глясе', price: 30, checked: false, half: false },
                { name: 'Мини фитчи', price: 12, checked: false, half: false },
                ...
                { name: 'Нагетсы микс + фри', price: 32, checked: false, half: true },
                { name: 'Напитки (безлимит)', price: 35, checked: false, half: false },
                { name: 'Куриные ножки + фри', price: 25, checked: false, half: true }
            ]
        },
        {
            title: 'САЛАТЫ',
            dishes: [
                { name: 'Оливье', price: 10, checked: false, half: true },
                { name: 'Мужской салат', price: 22, checked: false, half: true },
                { name: 'Оливье с мясом', price: 12, checked: false, half: true },
        ...
        },
        {
            ...
            dishes: [
                ...
                { name: 'Жаркое в горшочке', price: 65, checked: false, half: false },
                { name: 'Ярма из говядины', price: 15, checked: false, half: false },
                { name: 'Биф с картофелем', price: 65, checked: false, half: false },
                { name: 'Плов из говядины', price: 50, checked: false, half: false },
                ...
                { name: 'Нохут чорба из говядины', price: 55, checked: false, half: false },
                ...
                { name: 'Манты ассорти 3 вида', price: 20, checked: false, half: true },
                ...
                { name: 'Куриная грудка с овощами с рисом по-турецки', price: 60, checked: false, half: false },
                ...
                { name: 'Мангал микс "Бахар"', price: 100, checked: false, half: false },
