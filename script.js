    ...
    const menuCategories = [
        ...
        },
        {
            ...
            dishes: [
                ...
                { name: 'Персидский плов (общая)', price: 35, checked: false },
                { name: 'Долма и голубцы', price: 25, checked: false },
                { name: 'Бедене запеченные с кускусом (общая)', price: 55, checked: false },
                { name: 'Гутапы с мясом', price: 10, checked: false },
                { name: 'Каре ягненка с ярмой (общая)', price: 65, checked: false },
                { name: 'Чебуреки с мясом', price: 10, checked: false },
                { name: 'Рыба жаренная с овощным гарниром (общая)', price: 100, checked: false },
                { name: 'Узбекская сомса', price: 12, checked: false },
                { name: 'Рыбный микс "VIP" на доске', price: 160, checked: false },
                { name: 'Куриная грудка с ризотто', price: 55, checked: false },
                { name: 'Куриный микс на доске', price: 70, checked: false },
                { name: 'Куриная грудка с овощами с рисом по-турецки', price: 62, checked: false },
                { name: 'Мясной микс на доске', price: 110, checked: false },
                { name: 'Курица в слив.соусе с рисом по-турецки', price: 55, checked: false },
                { name: 'Микс гриль на доске', price: 110, checked: false },
                { name: 'Куриное фрикасе с арпой', price: 55, checked: false },
                { name: 'Шашлыки 3 вида', price: 80, checked: false },
                { name: 'Куриный рулет с рисом', price: 45, checked: false },
